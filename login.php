...
<div class="page-wraper">
	...
	<div class="account-form">
		<div class="account-head" style="background-image:url(assets/images/login.jpg);">
				...
				<form class="contact-bx" method="post">
					<div class="row placeani">
						...
						<div class="col-lg-12 m-b30">
							<center><button name="login" type="submit" value="Submit" class="btn button-md">Login</button></center>
						</div>
