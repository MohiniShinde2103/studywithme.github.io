<div class="modal fade" id="display<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="mt-5">
      <center> 
          <form method="post" action=""><br>
                ...
                ?>
                <img src="<?php echo $imageURL; ?>" alt="" style="width:80%;height:100%;" />
