...
$conn=mysqli_connect('sql311.epizy.com','epiz_25827727','0vwlrWNM5hh','epiz_25827727_ecampus');
   ...
   $sql = "SELECT username, staffname FROM staff_info where username='$Un'";
...
<body id="body" style="background-repeat: no-repeat; background:linear-gradient(90deg, rgba(29,31,31,1) 6%, rgba(104,107,107,1) 31%, rgba(201,212,213,1) 50%, rgba(104,107,107,1) 75%, rgba(15,15,15,1) 95%); ">
 ...
 "></i>
  ...
  <div id="bd" class="cla" >
    <div style=" background-color: rgba(255, 254, 255, 0.7 ); padding-top: 0%; padding-bottom: 0%; border-bottom-right-radius: 15px; border-top-left-radius: 15px; margin-top: 10%; "><center><font size="6"> Welcome Staff!</font></center>
    </div>
        ...
        <div style=" background-color: rgba(255, 254, 255, 0.7 ); padding-top: 0%; padding-bottom: 5%; border-bottom-right-radius: 15px; border-top-left-radius: 15px; margin-top: 3%; ">
          ...
          <form align="center" >
          <br>
          <label><b>ID:</b></label>&nbsp;&nbsp; <br> <input class="input-field" type="text" name="name" style="border-top-left-radius: 15px; width: 80%; padding: 10px; height: 40px; border: solid; border-color: #b3b3b3; border-bottom-right-radius: 15px;" value="<?php echo $unm; ?>"readonly>
          <br><br><br><br>
          <label><b>Name:   </b></label>&nbsp;&nbsp;&nbsp; <br><input class="input-field" type="text"  value="<?php echo $ps; ?>"  name="name" style="border-top-left-radius: 15px; width: 80%; padding: 10px; height: 40px; border:solid; border-color: #b3b3b3; border-bottom-right-radius: 15px;"readonly>
          <br><br><br><br>
...
<form method="post" action="">
    ...
    <div class="mt-5">
      <center>
          ...
          <br>
            <img src="3.jpg" hspace="22px;"  style="height: 40%; width: 40%; border: solid; border-color: white; border-bottom-right-radius:14%; border-top-left-radius: 14%; "></img><br><font size="4" ><u>Change Password</u></font><br><br>
